...
class TestEstadoRUS:
    def test_calculo_impuesto_base(self):
        """Verifica que el impuesto base = ventas * 0.05"""
        ventas = 560.00
        esperado = 560.00 * 0.05  # = 28.00
        from src.calculators.calculadora_rus import CalculadoraRUS
        # Sin percepciones, el impuesto final = impuesto base
    ...
    def test_calculo_impuesto_con_percepcion(self):
        """Verifica que resta las percepciones del impuesto base"""
        ventas = 560.00
        percepciones = 8.83
        impuesto_base = 560.00 * 0.05  # = 28.00
        esperado = impuesto_base - percepciones  # = 19.17
        from src.calculators.calculadora_rus import CalculadoraRUS
    ...
    def test_limite_rus_seguro(self):
        """Doña María está a S/ 7,440 del límite"""
        ventas = 560.00
        limite = 8000.00
